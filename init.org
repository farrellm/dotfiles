...
** evil
#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "~/.emacs.d/evil-colemak-basics")
  ...
  (use-package evil-smartparens
    ...
    (defun evil-colemak-sp--add-bindings ()
      ...
      (evil-define-key 'normal evil-smartparens-mode-map
        ...
        (kbd "C") #'evil-sp-yank-line
        (kbd "W") #'evil-sp-change-line)
      (when smartparens-strict-mode
    ...
    (defun evil-colemak-sp--enable ()
      (evil-colemak-sp--add-bindings)
      (evil-sp--add-evil-surround-operators))

    (define-minor-mode evil-colemak-smartparens-mode
      "Toggle evil-smartparens for Colemak."
      :lighter " es"
      :init-value nil
      :keymap evil-smartparens-mode-map
      (when evil-colemak-smartparens-mode
        (evil-colemak-sp--enable)))

    :hook (smartparens-enabled . evil-colemak-smartparens-mode))
#+end_src
